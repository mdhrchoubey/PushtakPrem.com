...
const initPay = (data) => {
    const options = {
      ...
      handler: async (response) => {
        try {
          const verifyURL = "https://localhost:5002/api/payment/verify";
  ...
  const handlePay = async () => {
    try {
      const orderURL = "http://localhost:5002/api/payment/orders";
                ...
                <table className='paymentTbale'>
                    ...
                    <tr>
                        <td>
                          ...
                          {!userName? <button onClick={loginFirst} style={{width:"250px", height:"30px", marginLeft:"80px"}}>
                            Pay Now!
                            </button>:<button onClick={handlePay} style={{width:"250px", height:"30px", marginLeft:"80px"}}> Pay Now!</button>}
